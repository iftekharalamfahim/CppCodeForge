...
<div style="flex: 1; ">
<p><b>Duration:</b> 8 weeks intensive study</p>
<p><b>Start Date:</b> 2025-09-12  </p>
<p><b>Goal:</b> Build comprehensive C++ programming expertise</p>
<p><b>Approach:</b> Topic-based learning with practical implementation</p>
</div>

<div style="flex: 1; text-align: center;">
<img src="https://media.giphy.com/media/ZVik7pBtu9dNS/giphy.gif" width="150" alt="C++ Coding">
</div>
...
- `docs/notes/`: Contains markdown files with summaries of concepts learned each day.
- `docs/resources/`: Stores links to tutorials, articles, or cheatsheets I find helpful.
- `src/`: Organized by topic, containing C++ code files (e.g., 01-GettingStarted.cpp).
...
|02 - Structure of C++ Program|✔️|[code](CppCodeForge/src/02-StructureOfCppProgram/02-StructureOfCppProgram.cpp)|[Notes](CppCodeForge/docs/notes/02-StructureOfCppProgram.md)|2025-09-18|
|03 - Variables and Constants|⏳|--|--|--|
|04 - Arrays and Vectors|⏳|--|--|--|
|05 - Statements and Operators|⏳|--|--|--|
|06 - Controlling Program Flow|⏳|--|--|--|
|07 - Characters and Strings|⏳|--|--|--|
|08 - Functions|⏳|--|--|--|
...
**Current Progress:** 0/20 topics completed
...
```bash
git clone https://github.com/yourusername/CppLearningJourney.git
```
2. Navigate to the project directory:
```bash
cd CppLearningJourney/src/01-GettingStarted
```
3. Compile the code:
```bash
...
### Thank you for visiting my C++ Learning Journey!
Feel free to explore, provide feedback, or follow my progress.

<img src="https://media.giphy.com/media/13HgwGsXF0aiGY/giphy.gif" width="120" alt="Developer Working">
