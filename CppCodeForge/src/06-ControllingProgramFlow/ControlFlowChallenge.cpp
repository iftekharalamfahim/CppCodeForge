/*****************************************
*
 *Exercise for Controlling Program Flow
 *
...
/*
 * This challenge is about using a collection (list) of integers and allowing the user to select options from a menu to
 ...
 do {
  ...
  if (selection == 'P' || selection == 'p') {
   ...
   if (numbers.size() == 0)
    ...
    for (auto num: numbers)
     total += num;
    cout << "The mean is: " << static_cast<double>(total)/numbers.size() << endl; // statci_cast to ensure the decimal number
   }
